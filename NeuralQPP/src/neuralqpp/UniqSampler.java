...
public class UniqSampler {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> samples = UniqSampler.sample(A, k).stream().collect(Collectors.toList());
        ...
        samples = UniqSampler.sample(A, w, k).stream().collect(Collectors.toList());
        System.out.println(samples);
    }
}