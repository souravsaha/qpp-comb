...
then
    ...
    echo "5. No. of feedback documents to be used.";
    exit 1;
fi
...
java -Xmx1g -cp $CLASSPATH:dist/NeuralQpp.jar model.aware.baseline.RetrievalScoreAnalyzer $prop_name
