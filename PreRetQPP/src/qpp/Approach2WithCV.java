...
public class Approach2WithCV {
    ...
    public Approach2WithCV(String propPath) throws IOException, SAXException, Exception {
    ...
    private void processOneQuery(TRECQuery query) throws IOException, Exception {
...
//        Collections.shuffle(queries);
        ...
        double maxAvgRho = -2, maxAvgTau = -2;
...
//            maxRho = maxTau = -2;
        ...
        System.out.println("maxRho: " + maxAvgRho + " maxTau + "+ maxAvgTau);
    ...
    public static void main(String[] args) throws Exception {
        ...
        if(args.length != 0)
            obj = new Approach2WithCV(args[0]);
        else {
//            System.out.println("Usage: java Approach2WithCV <properties.file>");
            args = new String[1];
...
class TermSimilarity {
    ...
    public TermSimilarity(String term, float similarity) {
        this.term = term;
