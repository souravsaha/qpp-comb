...
public class Approach3 {
    ...
    public Approach3(String propPath) throws IOException, SAXException, Exception {
     ...
     */
    public void crossValidation(int K, List<TRECQuery> queries) {
...
//        int processedQueryCount = 0;
        ...
        System.out.println("RHO: "+cor.correlation(allAP, allQPP) + " TAU: "
...
//            System.out.println("Usage: java Approach2 <properties.file>");
        ...
        {
            obj.alpha = i;
            System.out.print(obj.alpha+ " ");
//            obj.crossValidation(5, obj.queries);
            obj.processedQueryCount = 0;
            obj.processAll();
        }
